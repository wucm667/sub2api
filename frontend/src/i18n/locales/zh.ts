  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexCliVersion: 'Codex CLI 版本固定',
        openaiCodexCliVersionPlaceholder: '0.131.0',
        openaiCodexCliVersionHint: '留空 = 透传下游 UA 原版本号\n填值 = 将下游 codex_cli_rs/X.Y.Z 的版本号统一改写为此值\n仅影响 originator 为 codex_cli_rs 的流量，其它客户端原样透传',
        openaiCodexCliVersionInvalid: '版本号格式应为 X.Y.Z，可附加 -beta.1 这类预发布标记。',
