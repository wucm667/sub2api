export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      modePreBlockDesc: 'Pre-block mode uses synchronous review before each request and rejects hits immediately.',
      modeObserve: 'Observe Only',
      modeObserveDesc: 'Observe mode only uses the async queue; requests pass through while hits are recorded, notified, and counted.',
      modeOff: 'Off',
      ...
      processed: 'Processed',
      asyncProcessed: 'Async Processed',
