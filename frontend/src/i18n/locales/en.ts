  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexCliVersion: 'Codex CLI Version Pinning',
        openaiCodexCliVersionPlaceholder: '0.131.0',
        openaiCodexCliVersionHint: 'Empty = pass through the downstream UA version\nSet = rewrite downstream codex_cli_rs/X.Y.Z to this version\nOnly affects codex_cli_rs traffic; other clients pass through unchanged',
        openaiCodexCliVersionInvalid: 'Version must be X.Y.Z, optionally with a prerelease suffix such as -beta.1.',
